...
libgif.dll: $(OBJECTS) $(HEADERS)
	$(CC) $(CFLAGS) -static -shared $(LDFLAGS) -Wl,--out-implib,libgif.dll.$(LIBMAJOR) -o libgif.dll $(OBJECTS)

libgif.a: $(OBJECTS) $(HEADERS)
	$(AR) rcs libgif.a $(OBJECTS)

libutil.dll: $(UOBJECTS) $(UHEADERS)
	$(CC) $(CFLAGS) -static -shared $(LDFLAGS) -Wl,--out-implib,libutil.dll.$(LIBMAJOR) -o libutil.dll $(UOBJECTS) -L. -lgif
